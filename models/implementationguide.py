...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 4.0.0-a53ec6ee1b (http://hl7.org/fhir/StructureDefinition/ImplementationGuide) on 2019-07-03.
...
#        List of `ImplementationGuideDependsOn` items
#
# (represented as `dict` in JSON). """
#
#
...
#        List of `ImplementationGuideGlobal` items
#
# (represented as `dict` in JSON). """
#
#
...
#        List of `ImplementationGuideDefinitionGrouping` items
#
# (represented as `dict` in JSON). """
#
#
...
#        List of `ImplementationGuideDefinitionParameter` items
#
# (represented as `dict` in JSON). """
#
#
...
#        List of `ImplementationGuideDefinitionResource` items
#
# (represented as `dict` in JSON). """
#
#
...
#        List of `ImplementationGuideDefinitionTemplate` items
#
# (represented as `dict` in JSON). """
#
...
#        List of `ImplementationGuideDefinitionPage` items
#
# (represented as `dict` in JSON). """
#
#
...
#        List of `ImplementationGuideManifestPage` items
#
# (represented as `dict` in JSON). """
#
#
...
#        self.resource = None
#        """ Resource in the implementation guide.
#        List of `ImplementationGuideManifestResource` items
#
# (represented as `dict` in JSON). """
#
