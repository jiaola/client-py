...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 4.0.0-a53ec6ee1b (http://hl7.org/fhir/StructureDefinition/Questionnaire) on 2019-07-03.
...
#        List of `QuestionnaireItem` items
#
# (represented as `dict` in JSON). """
#
#
...
#        """ Permitted answer.
#        List of `QuestionnaireItemAnswerOption` items
#
# (represented as `dict` in JSON). """
#
#
...
#        List of `QuestionnaireItemEnableWhen` items
#
# (represented as `dict` in JSON). """
#
#
...
#        List of `QuestionnaireItemInitial` items
#
# (represented as `dict` in JSON). """
#
#
