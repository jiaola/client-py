...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 4.0.0-a53ec6ee1b (http://hl7.org/fhir/StructureDefinition/PractitionerRole) on 2019-07-03.
...
#        List of `PractitionerRoleAvailableTime` items
#
...
#        List of `PractitionerRoleNotAvailable` items
#
# (represented as `dict` in JSON). """
#
#
