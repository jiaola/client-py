...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 4.0.0-a53ec6ee1b (http://hl7.org/fhir/StructureDefinition/Device) on 2019-07-03.
...
#        List of `DeviceDeviceName` items
#
# (represented as `dict` in JSON). """
#
#
...
#        """ The capabilities supported on a  device, the standards to which the
        ...
        communication.
#        List of `DeviceSpecialization` items
#
# (represented as `dict` in JSON). """
#
#
...
#        List of `DeviceUdiCarrier` items
#
# (represented as `dict` in JSON). """
#
#
