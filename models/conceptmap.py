...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 4.0.0-a53ec6ee1b (http://hl7.org/fhir/StructureDefinition/ConceptMap) on 2019-07-03.
...
#        List of `ConceptMapGroupElement` items
#
# (represented as `dict` in JSON). """
#
#
...
#        List of `ConceptMapGroupElementTarget` items
#
# (represented as `dict` in JSON). """
#
...
#        List of `ConceptMapGroupElementTargetDependsOn` items
#
# (represented as `dict` in JSON). """
#
#
