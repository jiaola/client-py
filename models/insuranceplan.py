...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 4.0.0-a53ec6ee1b (http://hl7.org/fhir/StructureDefinition/InsurancePlan) on 2019-07-03.
...
#        List of `InsurancePlanContact` items
#
# (represented as `dict` in JSON). """
#
#
#        self.coverage = None
#        """ Coverage details.
#        List of `InsurancePlanCoverage` items
#
# (represented as `dict` in JSON). """
#
#
...
#        self.plan = None
#        """ Plan details.
#        List of `InsurancePlanPlan` items
#
# (represented as `dict` in JSON). """
#
#
...
#        self.benefit = None
#        """ List of benefits.
#        List of `InsurancePlanCoverageBenefit` items
#
# (represented as `dict` in JSON). """
#
#
...
#        self.limit = None
#        """ Benefit limits.
#        List of `InsurancePlanCoverageBenefitLimit` items
#
# (represented as `dict` in JSON). """
#
#
...
#        """ Overall costs.
#        List of `InsurancePlanPlanGeneralCost` items
#
# (represented as `dict` in JSON). """
#
#
...
#        """ Specific costs.
#        List of `InsurancePlanPlanSpecificCost` items
#
# (represented as `dict` in JSON). """
#
#
...
#        self.benefit = None
#        """ Benefits list.
#        List of `InsurancePlanPlanSpecificCostBenefit` items
#
# (represented as `dict` in JSON). """
#
#
...
#        self.cost = None
#        """ List of the costs.
#        List of `InsurancePlanPlanSpecificCostBenefitCost` items
#
# (represented as `dict` in JSON). """
#
#
