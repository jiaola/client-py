...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 4.0.0-a53ec6ee1b (http://hl7.org/fhir/StructureDefinition/Immunization) on 2019-07-03.
...
#        List of `ImmunizationEducation` items
#
# (represented as `dict` in JSON). """
#
#
...
#        self.performer = None
#        """ Who performed event.
#        List of `ImmunizationPerformer` items
#
# (represented as `dict` in JSON). """
#
#
...
#        List of `ImmunizationProtocolApplied` items
#
# (represented as `dict` in JSON). """
#
#
...
#        List of `ImmunizationReaction` items
#
# (represented as `dict` in JSON). """
#
#
