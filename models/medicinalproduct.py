...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 4.0.0-a53ec6ee1b (http://hl7.org/fhir/StructureDefinition/MedicinalProduct) on 2019-07-03.
...
#        List of `MedicinalProductName` items
#
# (represented as `dict` in JSON). """
#
#
...
#        List of `MedicinalProductSpecialDesignation` items
#
# (represented as `dict` in JSON). """
#
#
...
#        List of `MedicinalProductNameCountryLanguage` items
#
# (represented as `dict` in JSON). """
#
#
...
#        List of `MedicinalProductNameNamePart` items
#
# (represented as `dict` in JSON). """
#
#
