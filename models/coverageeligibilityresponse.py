...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 4.0.0-a53ec6ee1b (http://hl7.org/fhir/StructureDefinition/CoverageEligibilityResponse) on 2019-07-03.
...
#        self.error = None
#        """ Processing errors.
#        List of `CoverageEligibilityResponseError` items
#
...
#        List of `CoverageEligibilityResponseInsurance` items
#
# (represented as `dict` in JSON). """
#
#
...
#        List of `CoverageEligibilityResponseInsuranceItem` items
#
# (represented as `dict` in JSON). """
#
