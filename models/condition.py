...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 4.0.0-a53ec6ee1b (http://hl7.org/fhir/StructureDefinition/Condition) on 2019-07-03.
...
#        self.evidence = None
#        """ Supporting evidence.
#        List of `ConditionEvidence` items
#
# (represented as `dict` in JSON). """
#
#
