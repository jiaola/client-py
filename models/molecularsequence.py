...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 4.0.0-a53ec6ee1b (http://hl7.org/fhir/StructureDefinition/MolecularSequence) on 2019-07-03.
...
#        List of `MolecularSequenceQuality` items
#
# (represented as `dict` in JSON). """
#
#
...
#        List of `MolecularSequenceRepository` items
#
# (represented as `dict` in JSON). """
#
#
...
#        """ Structural variant.
#        List of `MolecularSequenceStructureVariant` items
#
# (represented as `dict` in JSON). """
#
#
...
#        self.variant = None
#        """ Variant in sequence.
#        List of `MolecularSequenceVariant` items
#
# (represented as `dict` in JSON). """
#
