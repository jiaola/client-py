...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 4.0.0-a53ec6ee1b (http://hl7.org/fhir/StructureDefinition/TestScript) on 2019-07-03.
...
#        """ An abstract server representing a destination or receiver in a
        message exchange.
#        List of `TestScriptDestination` items
#
# (represented as `dict` in JSON). """
#
#
...
#        List of `TestScriptFixture` items
#
# (represented as `dict` in JSON). """
#
#
...
#        """ An abstract server representing a client or sender in a message
        exchange.
#        List of `TestScriptOrigin` items
#
# (represented as `dict` in JSON). """
#
#
...
#        List of `TestScriptVariable` items
#
# (represented as `dict` in JSON). """
#
#
...
#        """ Capabilities  that are assumed to function correctly on the FHIR
        server being tested.
#        List of `TestScriptMetadataCapability` items
#
# (represented as `dict` in JSON). """
#
#
...
#        List of `TestScriptMetadataLink` items
#
# (represented as `dict` in JSON). """
#
...
#        List of `TestScriptSetupAction` items
#
# (represented as `dict` in JSON). """
#
...
#        List of `TestScriptTeardownAction` items
#
# (represented as `dict` in JSON). """
#
...
#        List of `TestScriptTestAction` items
#
# (represented as `dict` in JSON). """
#
#
