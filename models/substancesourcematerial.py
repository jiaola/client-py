...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 4.0.0-a53ec6ee1b (http://hl7.org/fhir/StructureDefinition/SubstanceSourceMaterial) on 2019-07-03.
...
#        """ To do.
#        List of `SubstanceSourceMaterialPartDescription` items
#
# (represented as `dict` in JSON). """
#
#
...
#        List of `SubstanceSourceMaterialOrganismAuthor` items
#
# (represented as `dict` in JSON). """
#
#
