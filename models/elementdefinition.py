...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 4.0.0-a53ec6ee1b (http://hl7.org/fhir/StructureDefinition/ElementDefinition) on 2019-07-03.
...
#        List of `ElementDefinitionConstraint` items
#
# (represented as `dict` in JSON). """
#
#
...
#        List of `ElementDefinitionExample` items
#
# (represented as `dict` in JSON). """
#
#
...
#        List of `ElementDefinitionMapping` items
#
# (represented as `dict` in JSON). """
#
#
...
#        List of `ElementDefinitionType` items
#
# (represented as `dict` in JSON). """
#
...
#        List of `ElementDefinitionSlicingDiscriminator` items
#
# (represented as `dict` in JSON). """
#
#
