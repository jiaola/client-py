...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 4.0.0-a53ec6ee1b (http://hl7.org/fhir/StructureDefinition/Measure) on 2019-07-03.
...
#        List of `MeasureSupplementalData` items
#
# (represented as `dict` in JSON). """
#
#
...
#        """ Population criteria.
#        List of `MeasureGroupPopulation` items
#
# (represented as `dict` in JSON). """
#
#
...
#        List of `MeasureGroupStratifier` items
#
# (represented as `dict` in JSON). """
#
...
#        List of `MeasureGroupStratifierComponent` items
#
# (represented as `dict` in JSON). """
#
#
