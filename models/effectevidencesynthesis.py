...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 4.0.0-a53ec6ee1b (http://hl7.org/fhir/StructureDefinition/EffectEvidenceSynthesis) on 2019-07-03.
...
class EffectEvidenceSynthesis(domainresource.DomainResource):
    ...
    exposure:fhirreference.FHIRReference = None
    exposureAlternative:fhirreference.FHIRReference = None
...
#        List of `EffectEvidenceSynthesisCertainty` items
#
# (represented as `dict` in JSON). """
#
#
...
#        List of `EffectEvidenceSynthesisEffectEstimate` items
#
# (represented as `dict` in JSON). """
#
#
...
#        List of `EffectEvidenceSynthesisResultsByExposure` items
#
# (represented as `dict` in JSON). """
#
#
...
class EffectEvidenceSynthesisEffectEstimate(backboneelement.BackboneElement):
    ...
    variantState: Optional[codeableconcept.CodeableConcept] = None
...
class EffectEvidenceSynthesisResultsByExposure(backboneelement.BackboneElement):
    ...
    riskEvidenceSynthesis:fhirreference.FHIRReference = None
    variantState: Optional[codeableconcept.CodeableConcept] = None
