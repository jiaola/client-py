...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 4.0.0-a53ec6ee1b (http://hl7.org/fhir/StructureDefinition/ClaimResponse) on 2019-07-03.
...
#        List of `ClaimResponseAddItem` items
#
...
#        List of `ClaimResponseItemAdjudication` items
#
# (represented as `dict` in JSON). """
#
#
...
#        self.error = None
#        """ Processing errors.
#        List of `ClaimResponseError` items
#
# (represented as `dict` in JSON). """
#
#
...
#        List of `ClaimResponseInsurance` items
#
# (represented as `dict` in JSON). """
#
#
...
#        List of `ClaimResponseItem` items
#
# (represented as `dict` in JSON). """
#
#
...
#        List of `ClaimResponseProcessNote` items
#
# (represented as `dict` in JSON). """
#
#
...
#        self.total = None
#        """ Adjudication totals.
#        List of `ClaimResponseTotal` items
#
# (represented as `dict` in JSON). """
#
#
...
#        List of `ClaimResponseAddItemDetail` items
#
# (represented as `dict` in JSON). """
#
#
...
#        self.subDetail = None
#        """ Insurer added line items.
#        List of `ClaimResponseAddItemDetailSubDetail` items
#
# (represented as `dict` in JSON). """
#
#
...
#        List of `ClaimResponseItemDetail` items
#
# (represented as `dict` in JSON). """
#
#
...
#        List of `ClaimResponseItemDetailSubDetail` items
#
# (represented as `dict` in JSON). """
#
