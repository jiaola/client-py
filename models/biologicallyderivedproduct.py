...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 4.0.0-a53ec6ee1b (http://hl7.org/fhir/StructureDefinition/BiologicallyDerivedProduct) on 2019-07-03.
...
#        List of `BiologicallyDerivedProductProcessing` items
#
# (represented as `dict` in JSON). """
#
#
...
#        self.storage = None
#        """ Product storage.
#        List of `BiologicallyDerivedProductStorage` items
#
# (represented as `dict` in JSON). """
#
