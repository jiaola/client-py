...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 4.0.0-a53ec6ee1b (http://hl7.org/fhir/StructureDefinition/TerminologyCapabilities) on 2019-07-03.
...
#        List of `TerminologyCapabilitiesCodeSystem` items
#
# (represented as `dict` in JSON). """
#
#
...
#        List of `TerminologyCapabilitiesCodeSystemVersion` items
#
# (represented as `dict` in JSON). """
#
...
#        List of `TerminologyCapabilitiesExpansionParameter` items
#
# (represented as `dict` in JSON). """
#
#
