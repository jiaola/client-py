...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 4.0.0-a53ec6ee1b (http://hl7.org/fhir/StructureDefinition/TestReport) on 2019-07-03.
...
#        """ A participant in the test execution, either the execution engine, a
        client, or a server.
#        List of `TestReportParticipant` items
#
# (represented as `dict` in JSON). """
#
#
...
#        List of `TestReportSetupAction` items
#
# (represented as `dict` in JSON). """
#
...
#        List of `TestReportTeardownAction` items
#
# (represented as `dict` in JSON). """
#
...
#        List of `TestReportTestAction` items
#
# (represented as `dict` in JSON). """
#
#
