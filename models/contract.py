...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 4.0.0-a53ec6ee1b (http://hl7.org/fhir/StructureDefinition/Contract) on 2019-07-03.
...
#        List of `ContractFriendly` items
#
# (represented as `dict` in JSON). """
#
#
...
#        List of `ContractTermAction` items
#
# (represented as `dict` in JSON). """
#
#
...
#        List of `ContractTermAsset` items
#
# (represented as `dict` in JSON). """
#
#
...
#        List of `ContractTermSecurityLabel` items
#
# (represented as `dict` in JSON). """
#
#
...
#        List of `ContractTermActionSubject` items
#
# (represented as `dict` in JSON). """
#
#
...
#        self.answer = None
#        """ Response to assets.
#        List of `ContractTermOfferAnswer` items
#
# (represented as `dict` in JSON). """
#
#
...
#        List of `ContractTermAssetContext` items
#
# (represented as `dict` in JSON). """
#
#
...
#        List of `ContractTermAssetValuedItem` items
#
# (represented as `dict` in JSON). """
#
...
#        self.party = None
#        """ Offer Recipient.
#        List of `ContractTermOfferParty` items
#
# (represented as `dict` in JSON). """
#
#
