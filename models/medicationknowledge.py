...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 4.0.0-a53ec6ee1b (http://hl7.org/fhir/StructureDefinition/MedicationKnowledge) on 2019-07-03.
...
#        List of `MedicationKnowledgeCost` items
#
# (represented as `dict` in JSON). """
#
#
...
#        List of `MedicationKnowledgeDrugCharacteristic` items
#
# (represented as `dict` in JSON). """
#
#
...
#        List of `MedicationKnowledgeIngredient` items
#
# (represented as `dict` in JSON). """
#
#
...
#        List of `MedicationKnowledgeKinetics` items
#
# (represented as `dict` in JSON). """
#
#
...
#        List of `MedicationKnowledgeMedicineClassification` items
#
# (represented as `dict` in JSON). """
#
#
...
#        List of `MedicationKnowledgeMonitoringProgram` items
#
# (represented as `dict` in JSON). """
#
#
...
#        List of `MedicationKnowledgeMonograph` items
#
# (represented as `dict` in JSON). """
#
#
...
#        List of `MedicationKnowledgeRegulatory` items
#
# (represented as `dict` in JSON). """
#
#
...
#        List of `MedicationKnowledgeAdministrationGuidelinesPatientCharacteristics` items
#
# (represented as `dict` in JSON). """
#
...
#        List of `MedicationKnowledgeRegulatorySchedule` items
#
# (represented as `dict` in JSON). """
#
#
...
#        List of `MedicationKnowledgeRegulatorySubstitution` items
#
# (represented as `dict` in JSON). """
#
