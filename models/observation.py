...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 4.0.0-a53ec6ee1b (http://hl7.org/fhir/StructureDefinition/Observation) on 2019-07-03.
...
#        self.component = None
#        """ Component results.
#        List of `ObservationComponent` items
#
# (represented as `dict` in JSON). """
#
#
...
#        List of `ObservationReferenceRange` items
#
# (represented as `dict` in JSON). """
#
#
