...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 4.0.0-a53ec6ee1b (http://hl7.org/fhir/StructureDefinition/SubstanceNucleicAcid) on 2019-07-03.
...
#        List of `SubstanceNucleicAcidSubunit` items
#
# (represented as `dict` in JSON). """
#
...
#        List of `SubstanceNucleicAcidSubunitLinkage` items
#
# (represented as `dict` in JSON). """
#
#
...
#        List of `SubstanceNucleicAcidSubunitSugar` items
#
# (represented as `dict` in JSON). """
#
#
