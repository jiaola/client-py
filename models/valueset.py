...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 4.0.0-a53ec6ee1b (http://hl7.org/fhir/StructureDefinition/ValueSet) on 2019-07-03.
...
#        List of `ValueSetComposeInclude` items
#
# (represented as `dict` in JSON). """
#
#
...
#        List of `ValueSetComposeIncludeConcept` items
#
# (represented as `dict` in JSON). """
#
#
...
#        List of `ValueSetComposeIncludeFilter` items
#
# (represented as `dict` in JSON). """
#
#
...
#        List of `ValueSetComposeIncludeConceptDesignation` items
#
# (represented as `dict` in JSON). """
#
#
...
#        List of `ValueSetExpansionContains` items
#
# (represented as `dict` in JSON). """
#
#
...
#        List of `ValueSetExpansionParameter` items
#
# (represented as `dict` in JSON). """
#
#
