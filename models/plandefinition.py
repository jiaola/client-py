...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 4.0.0-a53ec6ee1b (http://hl7.org/fhir/StructureDefinition/PlanDefinition) on 2019-07-03.
...
#        List of `PlanDefinitionAction` items
#
...
#        List of `PlanDefinitionGoal` items
#
# (represented as `dict` in JSON). """
#
#
...
#        List of `PlanDefinitionActionCondition` items
#
# (represented as `dict` in JSON). """
#
#
...
#        List of `PlanDefinitionActionDynamicValue` items
#
# (represented as `dict` in JSON). """
#
#
...
#        List of `PlanDefinitionActionParticipant` items
#
# (represented as `dict` in JSON). """
#
#
...
#        List of `PlanDefinitionActionRelatedAction` items
#
# (represented as `dict` in JSON). """
#
#
...
#        List of `TriggerDefinition` items
#
# (represented as `dict` in JSON). """
#
#
...
#        List of `PlanDefinitionGoalTarget` items
#
# (represented as `dict` in JSON). """
#
