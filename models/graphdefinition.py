...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 4.0.0-a53ec6ee1b (http://hl7.org/fhir/StructureDefinition/GraphDefinition) on 2019-07-03.
...
#        List of `GraphDefinitionLink` items
#
# (represented as `dict` in JSON). """
#
#
...
#        List of `GraphDefinitionLinkTarget` items
#
# (represented as `dict` in JSON). """
#
...
#        List of `GraphDefinitionLinkTargetCompartment` items
#
# (represented as `dict` in JSON). """
#
#
