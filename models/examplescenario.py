...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 4.0.0-a53ec6ee1b (http://hl7.org/fhir/StructureDefinition/ExampleScenario) on 2019-07-03.
...
#        List of `ExampleScenarioActor` items
#
...
#        List of `ExampleScenarioInstance` items
#
# (represented as `dict` in JSON). """
#
#
...
#        List of `ExampleScenarioProcess` items
#
# (represented as `dict` in JSON). """
#
#
...
#        List of `ExampleScenarioInstanceContainedInstance` items
#
# (represented as `dict` in JSON). """
#
#
...
#        List of `ExampleScenarioInstanceVersion` items
#
# (represented as `dict` in JSON). """
#
...
#        List of `ExampleScenarioProcessStep` items
#
# (represented as `dict` in JSON). """
#
#
...
#        List of `ExampleScenarioProcessStepAlternative` items
#
# (represented as `dict` in JSON). """
#
#
