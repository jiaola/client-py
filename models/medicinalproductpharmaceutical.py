...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 4.0.0-a53ec6ee1b (http://hl7.org/fhir/StructureDefinition/MedicinalProductPharmaceutical) on 2019-07-03.
...
#        List of `MedicinalProductPharmaceuticalRouteOfAdministrationTargetSpecies` items
#
# (represented as `dict` in JSON). """
#
...
#        """ A species specific time during which consumption of animal product
        is not appropriate.
#        List of `MedicinalProductPharmaceuticalRouteOfAdministrationTargetSpeciesWithdrawalPeriod` items
#
# (represented as `dict` in JSON). """
#
