...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 4.0.0-a53ec6ee1b (http://hl7.org/fhir/StructureDefinition/MessageDefinition) on 2019-07-03.
...
#        List of `MessageDefinitionAllowedResponse` items
#
...
#        List of `MessageDefinitionFocus` items
#
# (represented as `dict` in JSON). """
#
#
