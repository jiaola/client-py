...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 4.0.0-a53ec6ee1b (http://hl7.org/fhir/StructureDefinition/SubstanceSpecification) on 2019-07-03.
...
#        List of `SubstanceSpecificationstr` items
#
...
#        List of `SubstanceSpecificationMoiety` items
#
# (represented as `dict` in JSON). """
#
#
...
#        List of `SubstanceSpecificationName` items
#
# (represented as `dict` in JSON). """
#
#
...
#        List of `SubstanceSpecificationProperty` items
#
# (represented as `dict` in JSON). """
#
#
...
#        """ A link between this substance and another, with details of the
        relationship.
#        List of `SubstanceSpecificationRelationship` items
#
# (represented as `dict` in JSON). """
#
#
...
#        List of `SubstanceSpecificationNameOfficial` items
#
# (represented as `dict` in JSON). """
#
#
...
#        List of `SubstanceSpecificationStructureIsotope` items
#
# (represented as `dict` in JSON). """
#
#
