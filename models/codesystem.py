...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 4.0.0-a53ec6ee1b (http://hl7.org/fhir/StructureDefinition/CodeSystem) on 2019-07-03.
...
#        List of `CodeSystemConcept` items
#
...
#        List of `CodeSystemFilter` items
#
# (represented as `dict` in JSON). """
#
#
...
#        List of `CodeSystemProperty` items
#
# (represented as `dict` in JSON). """
#
#
...
#        List of `CodeSystemConceptDesignation` items
#
# (represented as `dict` in JSON). """
#
#
...
#        List of `CodeSystemConceptProperty` items
#
# (represented as `dict` in JSON). """
#
