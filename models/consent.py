...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 4.0.0-a53ec6ee1b (http://hl7.org/fhir/StructureDefinition/Consent) on 2019-07-03.
...
#        List of `ConsentVerification` items
#
# (represented as `dict` in JSON). """
#
...
#        List of `ConsentProvisionActor` items
#
# (represented as `dict` in JSON). """
#
#
...
#        List of `ConsentProvisionData` items
#
# (represented as `dict` in JSON). """
#
#
...
#        List of `ConsentProvision` items
#
# (represented as `dict` in JSON). """
#
#
