...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 4.0.0-a53ec6ee1b (http://hl7.org/fhir/StructureDefinition/CoverageEligibilityRequest) on 2019-07-03.
...
#        List of `CoverageEligibilityRequestInsurance` items
#
# (represented as `dict` in JSON). """
#
#
...
#        List of `CoverageEligibilityRequestItem` items
#
# (represented as `dict` in JSON). """
#
#
...
#        List of `CoverageEligibilityRequestSupportingInfo` items
#
# (represented as `dict` in JSON). """
#
...
#        List of `CoverageEligibilityRequestItemDiagnosis` items
#
# (represented as `dict` in JSON). """
#
#
